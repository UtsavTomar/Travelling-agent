...
class TravelTasks:
    ...
    """
        ...
        agent=agent,
        expected_output="""a 7-day travel itinerary with detailed per-day plans,
    ...
    def identify_city(self, agent, origin, cities, interests, travel_dates):
     return Task(
        ...
        agent=agent,
        expected_output="""the best cities based on weather, season, prices, and traveler interests"""
    )
    ...
    def gather_city_info(self, agent, city, travel_dates, interests):
       return Task(
        ...
        agent=agent,
        expected_output="""Knowledgeable local guide with extensive information
