...
from tools2.search_tools import SearchTools
from tools2.calculator_tools import CalculatorTools
...
class TravelAgents:
    def __init__(self):
        self.llm = ChatGroq(
            api_key="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",
